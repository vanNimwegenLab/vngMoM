...
Define the dataframes specifying experimental conditions (see ReadMe.md):

```{r}

condition_ts <- rbind(data.frame(condition='lac_lowillum', duration=1440, medium='lactose') #,
                    # data.frame(condition='switch_4h',
...
# append useful variables to condition_ts
...
- If you use condition_ts appropriately, you should not need to call this loading step more than once per project.
...
myframes <- myfiles %>% 
  ...
  # convert to a dataframe with a unique column
